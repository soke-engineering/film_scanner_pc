...
ThumbnailContainer::ThumbnailContainer(QWidget *parent)
    : QWidget(parent), m_lastSelectedIndex(-1), m_thumbnailsPerRow(5), m_thumbnailWidth(150),
...
ThumbnailContainer::~ThumbnailContainer() { clearThumbnails(); }
...
void ThumbnailContainer::addThumbnail(const cv::Mat &mat)
{
    ...
    // Connect signals
    connect(thumbnail,
            &ThumbnailWidget::thumbnailClicked,
            this,
            &ThumbnailContainer::onThumbnailClicked);
    connect(thumbnail,
            &ThumbnailWidget::thumbnailDoubleClicked,
            this,
            &ThumbnailContainer::onThumbnailDoubleClicked);
...
QList<int> ThumbnailContainer::getSelectedIndices() const { return m_selectedIndices; }
...
void ThumbnailContainer::onThumbnailDoubleClicked(int index) { emit thumbnailDoubleClicked(index); }
