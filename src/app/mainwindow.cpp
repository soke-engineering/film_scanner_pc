...
static std::vector<std::string> getKnokkeV1Serials(void)
{
    FTDIEnumerator           enumerator;
    std::vector<std::string> allSerials = enumerator.getSerialNumbers();
...
void MainWindow::setDefaults(void)
{
    ...
    for (const std::string &serial : getKnokkeV1Serials())
    {
