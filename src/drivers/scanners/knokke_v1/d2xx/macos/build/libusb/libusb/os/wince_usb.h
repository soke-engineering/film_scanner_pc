...
DLL_DECLARE_FUNC(WINAPI,
                 BOOL,
                 UkwGetDeviceAddress,
                 (UKW_DEVICE, unsigned char *, unsigned char *, unsigned long *));
...
DLL_DECLARE_FUNC(WINAPI,
                 ...
                 (UKW_DEVICE, DWORD, LPUKW_CONTROL_HEADER, LPVOID, DWORD, LPDWORD, LPOVERLAPPED));
...
DLL_DECLARE_FUNC(WINAPI,
                 ...
                 (UKW_DEVICE, DWORD, UCHAR, LPVOID, DWORD, LPDWORD, LPOVERLAPPED));
