...
static int usbi_cond_intwait(usbi_cond_t *cond, usbi_mutex_t *mutex, DWORD timeout_ms)
{
...
void usbi_cond_broadcast(usbi_cond_t *cond)
{
    ...
    list_for_each_entry(pos, &cond->waiters, list, struct usbi_cond_perthread) SetEvent(pos->event);
