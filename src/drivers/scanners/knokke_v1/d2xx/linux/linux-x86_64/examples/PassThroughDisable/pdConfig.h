...
void PD_SetDefaultConfig(FT_EEPROM_PD *pPD_EEProm)
{
    ...
    pPD_EEProm->disenbm = GPIO_DRIVE_LOW; /// Discharge Enable BM, 0 for "Drive Low", 1 for "Drive
                                          /// Hi", 2 for "Input Mode", 3 for "Don't Care"
    pPD_EEProm->disdisbm = GPIO_DRIVE_HI; /// Discharge Disable BM, 0 for "Drive Low", 1 for "Drive
                                          /// Hi", 2 for "Input Mode", 3 for "Don't Care"
...
void BM_DefaultConfig(FT_EEPROM_PD *pPD_EEProm)
{
    for (int i = 0; i < 7; i++)
    {
        ...
        pPD_EEProm->PDO3_GPIO[i] = GPIO_DONT_CARE; // PDO3 GPIO1 to GPIO7
        pPD_EEProm->PDO4_GPIO[i] = GPIO_DONT_CARE; // PDO4 GPIO1 to GPIO7
        if ((gDeviceType == FT_DEVICE_4233HP) || (gDeviceType == FT_DEVICE_2233HP) ||
        ...
        for (int i = 0; i < pPD_EEProm->count; i++)
        {
            ...
            {                                              // VSAFE5V
                ...
                if ((gDeviceType == FT_DEVICE_4233HP) || (gDeviceType == FT_DEVICE_2233HP) ||
                    (gDeviceType == FT_DEVICE_233HP))
                {
                    pPD_EEProm->PDO5_GPIO[i] =
                        GPIO_DRIVE_LOW; // PDO5 GPIO1 to GPIO7 (FTx233HP only)
                    pPD_EEProm->PDO6_GPIO[i] =
                        GPIO_DRIVE_LOW; // PDO6 GPIO1 to GPIO7 (FTx233HP only)
                    pPD_EEProm->PDO7_GPIO[i] =
                        GPIO_DRIVE_LOW; // PDO7 GPIO1 to GPIO7 (FTx233HP only)
                }
                pPD_EEProm->VSAFE5V_GPIO[i] = GPIO_DRIVE_HI; // VSAFE5V GPIO1 to GPIO7
            }
...
/// @param pPD_EEProm Pointer to the FT_EEPROM_PD structure to be configured.
/// @param bEnSRPRSwap Boolean value to enable (true) or disable (false) the Sink Request Power Role
/// Swap.
...
void PD_CFG_EnablePassThrough(FT_EEPROM_PD *pPD_EEProm,
                              bool          bEnPassThrough,
                              UCHAR         ucChargeThrough,
                              UCHAR         ucfullPower,
                              UCHAR         ucVsafe5v)
{
...
void PD1_LoadEnable(FT_EEPROM_PD *pPD_EEProm, UCHAR ucPd1LdEn) { pPD_EEProm->pd1lden = ucPd1LdEn; }
...
void PD_DischargePin(FT_EEPROM_PD *pPD_EEProm, UCHAR ucGpioVal) { pPD_EEProm->dispin = ucGpioVal; }
/// @brief Enable Discharge for BM - 0 for "Drive Low", 1 for "Drive Hi", 2 for "Input Mode", 3 for
/// "Don't Care"
/// @param pPD_EEProm Pointer to FT_EEPROM_PD structure
...
/// @param pPD_EEProm Pointer to FT_EEPROM_PD structure
/// @param ucGpioVal GPIO value
void PD_CCSelectInd(FT_EEPROM_PD *pPD_EEProm, UCHAR ucGpioVal) { pPD_EEProm->ccselect = ucGpioVal; }
/// @brief ISET1 Configuration
/// @param pPD_EEProm Pointer to FT_EEPROM_PD structure
/// @param ucGpioVal GPIO value
void PD_ISET1Config(FT_EEPROM_PD *pPD_EEProm, UCHAR ucGpioVal) { pPD_EEProm->iset1 = ucGpioVal; }
/// @brief ISET2 Configuration
/// @param pPD_EEProm Pointer to FT_EEPROM_PD structure
/// @param ucGpioVal GPIO value
void PD_ISET2Config(FT_EEPROM_PD *pPD_EEProm, UCHAR ucGpioVal) { pPD_EEProm->iset2 = ucGpioVal; }
/// @brief ISET3 Configuration
/// @param pPD_EEProm Pointer to FT_EEPROM_PD structure
/// @param ucGpioVal GPIO value
void PD_ISET3Config(FT_EEPROM_PD *pPD_EEProm, UCHAR ucGpioVal) { pPD_EEProm->iset3 = ucGpioVal; }
...
void PD_ISETPD2Enable(FT_EEPROM_PD *pPD_EEProm, bool bISET_PD2) { pPD_EEProm->isetpd2 = bISET_PD2; }
/// @brief Enable ISET
/// @param pPD_EEProm Pointer to FT_EEPROM_PD structure
...
void PD_TransitionTimer(FT_EEPROM_PD *pPD_EEProm, USHORT usTrTimer) { pPD_EEProm->trt = usTrTimer; }
...
void PD_NoResponseTimer(FT_EEPROM_PD *pPD_EEProm, USHORT usNRTimer) { pPD_EEProm->nrt = usNRTimer; }
...
void PD_IdleTimer(FT_EEPROM_PD *pPD_EEProm, USHORT usIdleTimer) { pPD_EEProm->it = usIdleTimer; }
/// @brief I2C Address (hex)
/// @param pPD_EEProm Pointer to FT_EEPROM_PD structure
/// @param ucI2cAddr I2C Address value
void PD_I2CAddress(FT_EEPROM_PD *pPD_EEProm, UCHAR ucI2cAddr) { pPD_EEProm->i2caddr = ucI2cAddr; }
...
void PD_PowerReserved(FT_EEPROM_PD *pPD_EEProm, UINT uiPowerRes) { pPD_EEProm->prou = uiPowerRes; }
/// @brief Trim settings
/// @param pPD_EEProm Pointer to FT_EEPROM_PD structure
...
void PD_ExtDCPower(FT_EEPROM_PD *pPD_EEProm, bool bExtDCPower) { pPD_EEProm->extdc = bExtDCPower; }
